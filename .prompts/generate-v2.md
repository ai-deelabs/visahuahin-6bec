...
Diagonal section splits with overlapping content blocks, asymmetric two-column hero — Oversized italic serif headlines contrasted with tight monospace labels — Dusty teal (#3D7A72) + off-white (#F5F0E8) + burnt sienna (#A0522D) + dark espresso (#1A0F0A) — Adventurous, sun-worn, travel-worn credibility
